...
(function(process) {
 ...
 while (a && 5 !== a.tag);
    ...
    function mc(a, b) {
      ...
      function f(b, c, d) {
        if (a)
          return b = vb(b, c, d), b.index = 0, b.sibling = null, b;
        b.expirationTime = d;
        b.effectTag = 0;
        b.index = 0;
        b.sibling = null;
      ...
      function K(a, b, c, d, e) {
        if (null === b || 10 !== b.tag)
          return b = wb(c, a.internalContextTag, d, e), b["return"] = a, b;
        b = f(b, c, d);
        b["return"] = a;
        return b;
      }
      function L(a, b, c) {
        ...
        if ("object" === typeof b && null !== b) {
          switch (b.$$typeof) {
            case Wa:
              if (b.type === ua)
                return b = wb(b.props.children, a.internalContextTag, c, b.key), b["return"] = a, b;
          ...
          if (Ab(b) || Ua(b))
            return b = wb(b, a.internalContextTag, c, null), b["return"] = a, b;
          zb(a, b);
        }
        return null;
      }
    ...
    function uc(a, b, c) {
      b && (xf[a] && (null != b.children || null != b.dangerouslySetInnerHTML ? l("137", a, c()) : void 0), null != b.dangerouslySetInnerHTML && (null != b.children ? l("60") : void 0, "object" === typeof b.dangerouslySetInnerHTML && "__html" in b.dangerouslySetInnerHTML ? void 0 : l("61")), null != b.style && "object" !== typeof b.style ? l("62", c()) : void 0);
    }
    function vc(a, b) {
      if (-1 === a.indexOf("-"))
    ...
    var Hf = H.canUseDOM && "TextEvent" in window && !bb && !Ye(),
        ...
        Da = null,
        ia = null,
        Ge = {injectFiberControlledHostComponent: function(a) {
            jb = a;
          }},
        Jf = Object.freeze({
          injection: Ge,
    ...
    var Kf = {
      ...
      extractEvents: function(a, b, c, d) {
        ...
        if ("select" === f || "input" === f && "file" === e.type)
          ...
          f = e.nodeName, !f || "input" !== f.toLowerCase() || "checkbox" !== e.type && "radio" !== e.type || (g = hf);
        if (g && (g = g(a, b)))
          return vd(g, c, d);
        k && k(a, e, b);
      ...
      topWheel: "wheel"
        ...
        cc = function(a, b) {
          ...
          for (d = 0; d < c.length; d++)
            if (!Nf.call(b, c[d]) || !Fd(a[c[d]], b[c[d]]))
              return !1;
          return !0;
        },
        Hd = function(a) {
            ...
            beginWork: function(a, b, c) {
              ...
              switch (b.tag) {
                case 0:
                  ...
                  d = d(e, g);
                  b.effectTag |= 1;
                  "object" === typeof d && null !== d && "function" === typeof d.render ? (b.tag = 2, e = ub(b), q(b, d), z(b, c), b = h(a, b, !0, e)) : (b.tag = 1, f(a, b, d), b.memoizedProps = e, b = b.child);
                  return b;
                case 1:
                  a: {
                    e = b.type;
    ...
    if (H.canUseDOM)
      if ("function" !== typeof requestIdleCallback) {
        var Kc = null,
            ...
            Hb = 33,
            eb = 33;
        var bg = Le ? {timeRemaining: function() {
    ...
    H.canUseDOM && ("textContent" in document.documentElement || (Oe = function(a, b) {
      if (3 === a.nodeType)
        a.nodeValue = b;
      else {
    ...
    var Qe = Object.freeze({default: Pe}),
        Pc = Qe && Pe || Qe;
