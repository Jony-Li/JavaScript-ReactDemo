...
var F = B,
    ...
    fa = {
      Properties: {
        ...
        defer: H,
        disabled: H,
        download: F.HAS_OVERLOADED_BOOLEAN_VALUE,
        draggable: K,
        formNoValidate: H,
        hidden: H,
        loop: H,
...
"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode x-height xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type xml:base xmlns:xlink xml:lang xml:space".split(" ").forEach(function(a) {
  ...
  N.Properties[b] = 0;
  N.DOMAttributeNames[b] = a;
});
F.injectDOMPropertyConfig(fa);
F.injectDOMPropertyConfig(N);
var ja = /["'&<>]/;
function O(a) {
...
var V = "function" === typeof Symbol && Symbol["for"] && Symbol["for"]("react.fragment") || 60107,
...
function xa(a, b) {
  for (; n.isValidElement(a); ) {
      ...
      if (d.componentWillMount(), h.length) {
        ...
        if (p && 1 === e.length)
          ...
          for (p = p ? 1 : 0; p < e.length; p++) {
            var m = e[p];
            if (m = "function" === typeof m ? m.call(d, q, g.props, a) : m)
              l ? (l = !1, q = k({}, q, m)) : k(q, m);
          }
          d.state = q;
        }
    ...
    if ("function" === typeof d.getChildContext) {
      g = c.childContextTypes;
      "object" !== typeof g ? w("107", Y(c) || "Unknown") : void 0;
      var A = d.getChildContext();
      for (var y in A)
        y in g ? void 0 : w("108", Y(c) || "Unknown", y);
    }
    A && (b = k({}, b, A));
  }
  return {
...
var Z = function() {
  function a(b, g) {
    ...
    n.isValidElement(b) ? b.type !== V ? b = [b] : (b = b.props.children, b = n.isValidElement(b) ? [b] : W(b)) : b = W(b);
    this.stack = [{
      domNamespace: R.html,
      children: b,
      childIndex: 0,
  ...
  a.prototype.render = function(a, g, c) {
    ...
    if (n.isValidElement(a))
      return a.type === V ? (a = W(a.props.children), this.stack.push({
        domNamespace: c,
        children: a,
        childIndex: 0,
        context: g,
  ...
  a.prototype.renderDOM = function(a, g, c) {
    ...
    if (e = f)
      na[b] && (null != e.children || null != e.dangerouslySetInnerHTML ? w("137", b, X()) : void 0), null != e.dangerouslySetInnerHTML && (null != e.children ? w("60") : void 0, "object" === typeof e.dangerouslySetInnerHTML && "__html" in e.dangerouslySetInnerHTML ? void 0 : w("61")), null != e.style && "object" !== typeof e.style ? w("62", X()) : void 0;
    e = f;
    ...
    for (r in e)
      if (e.hasOwnProperty(r)) {
        ...
        if (null != m) {
          if ("style" === r) {
            ...
            for (l in m)
              if (m.hasOwnProperty(l)) {
                var u = 0 === l.indexOf("--"),
                    v = m[l];
                null != v && (A += y + sa(l) + ":", y = l, u = null == v || "boolean" === typeof v || "" === v ? "" : u || "number" !== typeof v || 0 === v || U.hasOwnProperty(y) && U[y] ? ("" + v).trim() : v + "px", A += u, y = ";");
              }
            m = A || null;
          }
          l = null;
          ...
          u ? va.hasOwnProperty(r) || (l = r, l = la(l) && null != m ? l + "\x3d" + ('"' + O(m) + '"') : "") : l = ma(r, m);
          l && (q += " " + l);
        }
      }
    ...
    var r = q;
    e = "";
    T.hasOwnProperty(b) ? r += "/\x3e" : (r += "\x3e", e = "\x3c/" + a.type + "\x3e");
    a: {
